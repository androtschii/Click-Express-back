...
namespace ClickExpress.Api.Controller
{
    ...
    public class NewsController : ControllerBase
    {
        ...
        public NewsController(INewsActions newsActions, ILogger<NewsController> logger)
        {
        ...
        [HttpGet]
        [AllowAnonymous]
        public IActionResult GetAll([FromQuery] bool onlyPublished = true) => Ok(_newsActions.GetAllNewsAction(onlyPublished));
